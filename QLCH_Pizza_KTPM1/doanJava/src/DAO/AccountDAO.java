...
public class AccountDAO {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,"Lỗi đọc danh sách thông tin tài khoản");
        }
        ...
        public void updateThongtin(String hoten, String ngaysinh, String gioitinh ,String sodienthoai, String id, String diachi){
            try{           
                MySQLConnect connect = new MySQLConnect("localhost", "root", "", "pizza");
